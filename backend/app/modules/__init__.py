...
from app.modules import scanner  # noqa: F401  (Registrierung per Import-Seiteneffekt)
from app.modules import converter  # noqa: F401  (Registrierung per Import-Seiteneffekt)
